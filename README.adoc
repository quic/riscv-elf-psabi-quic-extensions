...
```shell
git clone --recurse-submodules https://github.com/qualcomm/riscv-elf-psabi-qualcomm-extensions.git
```

All in one single line:

```shell
git clone --recurse-submodules https://github.com/qualcomm/riscv-elf-psabi-qualcomm-extensions.git && cd riscv-elf-psabi-qualcomm-extensions && git submodule update --init --recursive
...
```shell
cd ./riscv-elf-psabi-qualcomm-extensions && make build
```
